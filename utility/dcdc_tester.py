...
if __name__ == "__main__":
    ...
    dmm_address = 3
    dmm_protocol = 'GPIB'
    dmm_port = generic_port.PyVisaPort(dmm_protocol, dmm_address, dmm_board)
    vin_dmm = dmm.HP34401A(dmm_port)
    vin_dmm.connect()
    ...
    for vin in vin_vect:
        ...
        if inp:
            ...
            for iout in iout_vect:
                ...
                iin_meas=float(pwrgen.get_P6Vchannel_measure_current())
                ...
                print "Vset=%.3f, Iset=%.3f, Vin=%.3f, Iin=%.3f, Vout=%.3f, Iout=%.3f, Pin=%.3f, Pout=%.3f, eff=%.3f" \
